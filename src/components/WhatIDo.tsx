        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing Agentic AI pipelines, Generative AI applications, and
                autonomous systems. From LLMs to Computer Vision, I deliver
                production-ready AI solutions across industries.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Anthropic</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Scalable Cloud-Native Applications</h4>
              <p>
                Building end-to-end applications with modern stacks and deploying
                them on AWS. From APIs to CI/CD pipelines to containerized
                services — I deliver systems that scale.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
